...
const English = {
  ...
  keyboardSettings: {
    ...
    qukeys: {
      ...
      minimumHoldTime: "Dual-Function Keys - Minimum hold time",
      minimumHoldTimeTip1: "This setting adjusts the minimum amount of time it takes for the “hold” function to activate.",
      minimumHoldTimeTip2: "Use this if you find that you’re getting unintended holds when typing quickly.",
      minimumHoldTimeTip3: "You may have to slow down when triggering a hold function.",
      maxIntervalForTapRepeat: "Dual-Function Keys - Max interval for tap repeat",
      maxIntervalForTapRepeatTip1: "This setting limits the maximum amount of time it takes to trigger a tap repeat.",
      maxIntervalForTapRepeatTip2: "With a high value, you have more time to trigger a tap-repeat.",
      maxIntervalForTapRepeatTip3: "With a low value, it becomes hard or impossible to trigger a tap-reapeat.",
